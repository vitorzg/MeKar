                ...
                if($sessao == 1){
                    if($_SESSION['nivel'] == 1 ||$_SESSION['nivel'] == 2){
                        ...
                        if(file_exists("./json/cars.json")){
                            ...
                            if(!empty($arq)){
                                echo"<h1>Lista - Carros</h1>
                                <button onClick=location.href="."'cadCars.php'"." id="."'addButton'".">Add</button>";
                                echo"
                                <div class=".'php'.">
                                <table>
                                <tr>
                                ...
                                foreach($arq as $el => $dados){
                                    ...
                                    <td>".($dados['cambio'])."</td>
                                    <td> R$".($dados['preco'])."</td>
                                    <td><button  class="."editButton"." onClick=".'"location.href='."'uptCars.php?cod={$el}'".'"'." ><img src="."./assets/editButtom.png"." alt="."Edit"." value=".'"edit"'."></button> <button onClick=".'"location.href='."'delCars.php?cod={$el}'".'"'." ><img src="."./assets/deleteButtom.png"." alt="."Delete"."></button></td>
                                    </tr>
                                    ";
                                }
                                echo"</table>"; 
